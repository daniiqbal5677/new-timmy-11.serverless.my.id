...
resource "aws_cloudfront_distribution" "cdn" {
  origin {
    ...
    origin_id   = "S3-new-timmy-11.serverless.my.id"
  }
  ...
  aliases = ["new-timmy-11.serverless.my.id"]
...
resource "aws_route53_record" "subdomain" {
  ...
  name    = "new-timmy-11.serverless.my.id"
  type    = "A"
  ...
  "Statement": [
    {
      ...
      "Principal": "*",
      "Action": "s3:GetObject",
      "Resource": "arn:aws:s3:::new-timmy-11.serverless.my.id/*"
    }
  ]
}
POLICY
